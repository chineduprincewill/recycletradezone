...
const OPEN_TRANSACTIONS_API = 'open-transactions';
...
const OpenTransactions = () => {
    ...
    const fetchTransactions = async () => {
        ...
        const response = await axios.get(OPEN_TRANSACTIONS_API,
            {
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 className="mb-sm-0">Open requests</h4>

                                <div className="page-title-right">
                                    <ol className="breadcrumb m-0">
                                        <li className="breadcrumb-item"><Link to="/dashboard">Dashboards</Link></li>
                                        <li className="breadcrumb-item active">Open requests</li>
                                    </ol>
                                </div>
