...
const PRODUCER_PRODUCTS_API = 'producer-products';
...
const ProducerProducts = () => {
    ...
    const fetchProducts = async () => {
        const response = await axios.get(PRODUCER_PRODUCTS_API,
            {
                ...
                <div className="container-fluid">
                                                ...
                                                <form >
                                                    <div className="row g-3 mb-0 align-items-center">
                                                        ...
                                                        <div className="col-auto">
                                                            <Link to='/new-product' className="btn btn-soft-success"><i className="ri-add-circle-line align-middle me-1"></i> New Product</Link>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                    ...
                    <div className="row">
                        <div className="card">
                            ...
                            {products === null ? <Spinner /> : (products === undefined ? <span className="bg-warning text-white p-2 my-3">Oops! it's like your session has expired. Sign out and Sign in again.</span> : <ProductsList products={products} />)}
                            </div>
                        </div>
                    </div>
                </div>
